                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        SizedBox(width: w*0.05 ,),
                        textLeftRubik('Archived Chats', darkTextColor, w600, size25),
                      ],
                    ),
                    // Padding(
                    ...
                    //     crossAxisAlignment: CrossAxisAlignment.center,
                    //     children: [
                    //       textLeftRubik('Messages', darkTextColor, w500, size18),
                    //       SizedBox(width: 5,),
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      textRoboto('No message(s) to show!', lightTextColor, w400, size17)
                                    ],
                                  )
                                ],
                              ):
                                          ...
                                          child:isArchiving?Center(child: CircularProgressIndicator(color:primaryColor),): Column(
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: textCenter('Unarchive this chat?', darkTextColor, w500, size18),
                                              ),
                                              SizedBox(height: 8,),
                                              Row(
                                                crossAxisAlignment: CrossAxisAlignment.center,
