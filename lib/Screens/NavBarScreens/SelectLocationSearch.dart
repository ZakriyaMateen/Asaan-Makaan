...
class SelectLocationSearch extends StatefulWidget {
  const SelectLocationSearch({Key? key}) : super(key: key);

  @override
  State<SelectLocationSearch> createState() => _SelectLocationSearchState();
}

class _SelectLocationSearchState extends State<SelectLocationSearch> {
